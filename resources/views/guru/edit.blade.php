                        ...
                        <form action="{{route('guru.update',$guru->id_guru)}}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nip"
                                    ...
                                    placeholder="Masukkan NIP" value="{{ old('nip', $guru->nip) }}">
                                @error('nip')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama"
                                    ...
                                    placeholder="Masukkan Nama" value="{{ old('nama', $guru->nama) }}">
                                @error('nama')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('jenis_kelamin') is-invalid @enderror"
                                    name="jenis_kelamin" id="jenis_kelamin" value="{{ old('jenis_kelamin', $guru->jenis_kelamin) }}">
                                    <option selected disabled>Pilih Jenis Kelamin</option>
                                    <option value="Laki-laki"
                                        {{ old('jenis_kelamin', $guru->jenis_kelamin) == 'Laki-laki' ? 'selected' : '' }}>Laki-laki</option>
                                    <option value="Perempuan"
                                        {{ old('jenis_kelamin', $guru->jenis_kelamin) == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                                </select>
                                @error('jenis_kelamin')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="bidang_mengajar"
                                    ...
                                    value="{{ old('bidang_mengajar', $guru->bidang_mengajar) }}">
