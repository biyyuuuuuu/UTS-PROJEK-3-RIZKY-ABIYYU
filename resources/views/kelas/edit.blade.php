                        ...
                        <form action="{{ route('kelas.update', $kelas->id_kelas) }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="kode_kelas"
                                    ...
                                    name="kode_kelas" placeholder="Masukkan Kode Kelas" value="{{ old('kode_kelas', $kelas->kode_kelas) }}">
                                @error('kode_kelas')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    id="nama_kelas" name="nama_kelas" placeholder="Masukkan Nama Kelas" value="{{ old('nama_kelas', $kelas->nama_kelas) }}">
                                @error('nama_kelas')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="tingkat"
                                    ...
                                    name="tingkat" placeholder="Masukkan Tingkat Kelas" value="{{ old('tingkat', $kelas->tingkat) }}">
                                @error('tingkat')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="wali_kelas_id" class="form-control @error('wali_kelas_id') is-invalid @enderror"
                                    name="wali_kelas_id" value="{{ old('wali_kelas_id', $kelas->wali_kelas_id) }}">
                                    <option value="" hidden>-- Pilih Wali Kelas --</option>
                                    @foreach ($guru as $data)
                                        <option value="{{ $data->id_guru }}" {{ old('wali_kelas_id', $kelas->wali_kelas_id) == $data->id_guru ? 'selected' : '' }}>{{ $data->nama }}</option>
                                    @endforeach
                                </select>
                                @error('wali_kelas_id')
                                    <div class="invalid-feedback">
