                            ...
                            <form action="{{ route('siswa.update', $siswa->id_siswa) }}" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="jenis_kelamin" id="jenis_kelamin">
                                        ...
                                        <option value="Laki-laki" @if (old('jenis_kelamin', $siswa->jenis_kelamin) == 'Laki-laki') selected @endif>
                                            Laki-laki</option>
                                        <option value="Perempuan" @if (old('jenis_kelamin', $siswa->jenis_kelamin) == 'Perempuan') selected @endif>
                                            Perempuan</option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="kelas"
                                        ...
                                        id="kelas" placeholder="Masukkan Kelas" value="{{ old('kelas', $siswa->kelas) }}">
